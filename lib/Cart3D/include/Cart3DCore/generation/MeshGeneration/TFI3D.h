#ifndef CART3D_GENERATION_ALGORITHM_TFI3D_H
#define CART3D_GENERATION_ALGORITHM_TFI3D_H
...
namespace Cart3D
{
	...
	class CART3D_GENERATION_CLASS TFI3D
	{
	public:
		/*
		...
		static void tfi_from_corners(
			const std::vector<cfloat>& glxnodes,
			const std::vector<cfloat>& glynodes,
			std::vector<cvector3d>& x,bool gen_surf);
		/*
		...
		* ( X402,   X412,   X422,   X432,   X442,   X452 )
		...
		static void tfi_from_edges(
			...
			const std::vector<cfloat>& glynodes,
			const std::vector<cfloat>& glznodes,
			std::vector<cvector3d>& x,bool gen_vol);
		/*
		* ( X000,   ...,  ...,  ...,  ...,  ...,  X060 )
		* ( ....,   ...,  ...,  ...,  ...,  ...,  ...  )
		* ( ....,   ...,  ...,  ...,  ...,  ...,  ...  )   First "layer"
		...
		* ( X403,  ...,  ...,  ...,  ...,  ...,  X463  )
		...
		static void tfi_from_corners(
			...
			const std::vector<cfloat>& glynodes,
			const std::vector<cfloat>& glznodes,
			std::vector<cvector3d>& x,bool gen_surf,bool gen_vol);
