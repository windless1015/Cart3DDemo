...
// +---------------------------------
// component-wise vmax/vmin
template<class N>
inline Vec2<N> vmax(const Vec2<N> &lhs, const Vec2<N> &rhs);
template<class N>
inline Vec2<N> vmin(const Vec2<N> &lhs, const Vec2<N> &rhs);
// +---------------------------------
...
template<class N>
inline N vmax(const Vec2<N> &vec);
template<class N>
inline N vmin(const Vec2<N> &vec);
// +---------------------------------
...
// component-wise vmax/vmin
template<class N>
inline Vec3<N> vmax(const Vec3<N> &lhs, const Vec3<N> &rhs);
template<class N>
inline Vec3<N> vmin(const Vec3<N> &lhs, const Vec3<N> &rhs);
// +---------------------------------
// dimension logic for projections
template<class N>
...
template<class N>
inline N vmax(const Vec3<N> &vec);
template<class N>
inline N vmin(const Vec3<N> &vec);
// +---------------------------------
// normalization functions
template<class N>
...
// component-wise vmax/vmin
template<class N>
inline Vec4<N> vmax(const Vec4<N> &lhs, const Vec4<N> &rhs);
template<class N>
inline Vec4<N> vmin(const Vec4<N> &lhs, const Vec4<N> &rhs);
// +---------------------------------
// dimension logic for projections
template<class N>
...
template<class N>
inline N vmax(const Vec4<N> &vec);
template<class N>
inline N vmin(const Vec4<N> &vec);
// +---------------------------------
// normalization functions
template<class N>
...
template<class N>
inline Vec2<N> vmax(const Vec2<N> &lhs, const Vec2<N> &rhs) {
    return Vec2<N>(gmax(lhs.x, rhs.x),
                   gmax(lhs.y, rhs.y));
}
template<class N>
inline Vec2<N> vmin(const Vec2<N> &lhs, const Vec2<N> &rhs) {
    return Vec2<N>(gmin(lhs.x, rhs.x),
                   gmin(lhs.y, rhs.y));
}
// +---------------------------------
// dimension logic for projections
...
template<class N>
inline N vmax(const Vec2<N> &vec) {
    return gmax(vec.x, vec.y);
}
template<class N>
inline N vmin(const Vec2<N> &vec) {
    return gmin(vec.x, vec.y);
}
// +---------------------------------
// normalization functions
template<class N>
...
inline bool operator == (const Vec3<N> &lhs, const Vec3<N> &rhs) {
	...
	return fabs(lhs.x - rhs.x) == 1e-8 &&
		fabs(lhs.y - rhs.y) == 1e-8 &&
		fabs(lhs.z - rhs.z) == 1e-8;
}
template<class N>
inline bool operator!=(const Vec3<N> &lhs, const Vec3<N> &rhs) {
...
template<class N>
inline Vec3<N> vmax(const Vec3<N> &lhs, const Vec3<N> &rhs) {
    return Vec3<N>(gmax(lhs.x, rhs.x),
                   gmax(lhs.y, rhs.y),
                   gmax(lhs.z, rhs.z));
}
template<class N>
inline Vec3<N> vmin(const Vec3<N> &lhs, const Vec3<N> &rhs) {
    return Vec3<N>(gmin(lhs.x, rhs.x),
                   gmin(lhs.y, rhs.y),
                   gmin(lhs.z, rhs.z));
}
// +---------------------------------
...
template<class N>
inline N vmax(const Vec3<N> &vec) {
    return gmax(vec.x, gmax(vec.y, vec.z));
}
template<class N>
inline N vmin(const Vec3<N> &vec) {
    return gmin(vec.x, gmin(vec.y, vec.z));
}
// +---------------------------------
// normalization functions
template<class N>
...
template<class N>
inline Vec4<N> vmax(const Vec4<N> &lhs, const Vec4<N> &rhs) {
    return Vec4<N>(gmax(lhs.x, rhs.x),
                   gmax(lhs.y, rhs.y),
                   gmax(lhs.z, rhs.z),
                   gmax(lhs.w, rhs.w));
}
template<class N>
inline Vec4<N> vmin(const Vec4<N> &lhs, const Vec4<N> &rhs) {
    return Vec4<N>(gmin(lhs.x, rhs.x),
                   gmin(lhs.y, rhs.y),
                   gmin(lhs.z, rhs.z),
                   gmin(lhs.w, rhs.w));
}
...
template<class N>
inline N vmax(const Vec4<N> &vec) {
    return gmax(gmax(vec.x, vec.y), gmax(vec.z, vec.w));
}
template<class N>
inline N vmin(const Vec4<N> &vec) {
    return gmin(gmin(vec.x, vec.y), gmin(vec.z, vec.w));
}
// +---------------------------------
// normalization functions
template<class N>
...
static inline double triArea(const Vec3d& a, const Vec3d& b, const Vec3d& c)
{
