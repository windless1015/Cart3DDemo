...
namespace GMPExt4 {
	...
	inline void join(GmpExt4_1 &out, const GmpExt4_2 &lhs, const GmpExt4_2 &rhs) {

		out.e3 = lhs.e03 * rhs.e12 - lhs.e13 * rhs.e02 + lhs.e23 * rhs.e01;
		out.e0 = -lhs.e02 * rhs.e01 + lhs.e01 * rhs.e02;
		out.e1 = lhs.e01 * rhs.e12 - lhs.e12 * rhs.e01;
		out.e2 = -lhs.e12 * rhs.e02 + lhs.e02 * rhs.e12;
	}
	...
	inline
		void crossproduct(GmpExt4_2 &out,
			const GmpExt4_2 &lhs,
			const GmpExt4_2 &rhs)
	{
		out.e01 = lhs.e13 * rhs.e23 - lhs.e23 * rhs.e13;
		out.e02 = lhs.e23 * rhs.e03 - lhs.e03 * rhs.e23;
		out.e03 = lhs.e13 * rhs.e03 - lhs.e03 * rhs.e13;
	}

	inline
		void offset(GmpExt4_1 &out,
			const GmpExt4_1 &lhs,
			const GmpExt4_2 &rhs)
	{
		out.e0 = lhs.e0 + rhs.e01;
		out.e1 = lhs.e1 + rhs.e02;
		out.e2 = lhs.e2 + rhs.e03;
	}


	inline
		void revoffset(GmpExt4_1 &out,
			const GmpExt4_1 &lhs,
			const GmpExt4_2 &rhs)
	{
		out.e0 = lhs.e0 - rhs.e01 * lhs.e3;
		out.e1 = lhs.e1 - rhs.e02 * lhs.e3;
		out.e2 = lhs.e2 - rhs.e03 * lhs.e3;
	}
