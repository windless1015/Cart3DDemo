#pragma once
#ifndef CART3D_QUEUE_H
#define CART3D_QUEUE_H
#include <utility>
#include <vector>
...
namespace Cart3D {
	...
	protected:
		ct_vector<size_t> id_to_heappos;
		ct_vector<priority_queue_node<Key, Priority>> heap;
	...
	template<class key, class proity>
	using update_sort_queue = updatable_priority_queue<key, proity>;
}
#endif