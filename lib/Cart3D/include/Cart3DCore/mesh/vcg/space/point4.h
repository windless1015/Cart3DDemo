...
public:
	...
	inline Point4(){}
	inline Point4( const T nx, const T ny, const T nz , const T nw ) : _Base(nx,ny,nz,nw) {}
	inline Point4(const T p[4]) : _Base(p) {}
	inline Point4(const Point4& p) : _Base(p.x(), p.y(), p.z(), p.w()) {}
	template<typename OtherDerived>
	inline Point4(const Eigen::MatrixBase<OtherDerived>& other) : _Base(other) {}
