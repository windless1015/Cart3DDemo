...
//#define EIGEN_MATRIXBASE_PLUGIN <vcg/space/eigen_matrixbase_addons.h>
//#define EIGEN_MATRIX_PLUGIN <vcg/space/eigen_matrix_addons.h>
...
template<typename Derived1, typename Derived2>
typename Derived1::Scalar Angle(const Eigen::MatrixBase<Derived1>& p1, const Eigen::MatrixBase<Derived2> & p2)
{
	EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived1)
	EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived2)
	EIGEN_STATIC_ASSERT_FIXED_SIZE(Derived1)
...
template<typename Derived1, typename Derived2>
typename Derived1::Scalar AngleN(const Eigen::MatrixBase<Derived1>& p1, const Eigen::MatrixBase<Derived2> & p2)
{
	EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived1)
	EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived2)
	EIGEN_STATIC_ASSERT_FIXED_SIZE(Derived1)
...
inline typename Derived1::Scalar Norm(const Eigen::MatrixBase<Derived1>& p)
{ return p.norm(); }

template<typename Derived1>
inline typename Derived1::Scalar SquaredNorm(const Eigen::MatrixBase<Derived1>& p)
{ return p.squaredNorm(); }

template<typename Derived1, typename Derived2>
inline typename Derived1::Scalar
...
inline const Eigen::CwiseUnaryOp<Eigen::internal::scalar_abs_op<typename Eigen::ei_traits<Derived>::Scalar>, Derived>
...
template<typename Derived>
inline const Eigen::CwiseBinaryOp<Eigen::internal::scalar_max_op<typename Eigen::ei_traits<Derived>::Scalar>,
																	Derived,
