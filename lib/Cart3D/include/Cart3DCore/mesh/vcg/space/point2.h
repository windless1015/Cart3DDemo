...
/**
	...
	*/
template <class Scalar> class Point2 : public Eigen::Matrix<Scalar,2,1>
{
//----------------------------------------
...
//----------------------------------------
public:
	typedef Eigen::Matrix<Scalar,2,1> Type;
...
//----------------------------------------
private:
	typedef Eigen::Matrix<Scalar,2,1> _Base;
public:
	using _Base::coeff;
	...
	inline Point2 () { }
	/// x,y constructor
	inline Point2 ( const Scalar nx, const Scalar ny ) : _Base(nx,ny) {}
	/// copy constructor
	inline Point2(Point2 const & p) : _Base(p) {}
	template<typename OtherDerived>
	inline Point2(const Eigen::MatrixBase<OtherDerived>& other) : _Base(other) {}
