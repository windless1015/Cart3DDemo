...
//namespace Eigen{
//
//template<class Scalar> struct ei_traits<vcg::Point3<Scalar> > : ei_traits<Eigen::Matrix<Scalar, 3, 1> >{};
//
...
public:
  ...
  inline Point3 () {}
  inline Point3(const ScalarType nx, const ScalarType ny, const ScalarType nz) : _Base(nx, ny, nz) {}
  inline Point3 ( Point3 const & p ) : _Base(p) {}
  inline Point3(const ScalarType nv[3]) : _Base(nv) {}
  template<typename OtherDerived>
  inline Point3(const Eigen::MatrixBase<OtherDerived>& other) : _Base(other) {}
  ...
  {
	  return Point3(ScalarType(P0), ScalarType(P1), ScalarType(P2));
  }
  vcg::Box3<ScalarType> GetBBox(vcg::Box3<ScalarType> &bb) const;
