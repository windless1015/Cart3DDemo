...
#include "triangle/LocatorKDTree.h"
...
public:
     ...
     */
    fast_map<Edge, BoundaryOverlapCount> overlapCount;
     ...
     */
    fast_map<Edge, EdgeVec> pieceToOriginals;
...
private:
     ...
     */
    fast_map<TriInd, LayerDepth> peelLayer(
