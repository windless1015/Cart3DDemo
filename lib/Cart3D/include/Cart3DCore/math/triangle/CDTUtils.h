...
using std::tie;
using std::tuple;
using Cart3D::fast_set;
using Cart3D::fast_map;
} // namespace CDT
...
typedef fast_set<Edge> EdgeUSet;             ///< Hash table of edges
typedef fast_set<TriInd> TriIndUSet;         ///< Hash table of triangles
typedef fast_map<TriInd, TriInd> TriIndUMap; ///< Triangle hash map
