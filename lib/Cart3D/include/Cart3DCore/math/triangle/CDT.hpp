...
CDT_INLINE_IF_HEADER_ONLY fast_map<Edge, EdgeVec>
EdgeToPiecesMapping(const fast_map<Edge, EdgeVec>& pieceToOriginals)
{
    fast_map<Edge, EdgeVec> originalToPieces;
    typedef fast_map<Edge, EdgeVec>::const_iterator Cit;
